...
CORPUS_DIR          = P["paths"]["corpus_dir"]
WORDS_CSV           = P["paths"]["words_csv"]
EMB_OUT             = P["paths"]["emb_float64"]
SEG_OUT             = P["paths"]["segments_csv"]
MODEL_NAME          = P["extract"]["model_name"]
TARGET_SR           = P["extract"]["target_sr"]
MIN_SEGMENT_SAMPLES = P["extract"]["min_segment_samples"]
MIN_SPEAKERS        = P["filter"]["min_speakers"]
MIN_OCC             = P["filter"]["min_occ"]
# ────────────────────────────────────────────────────────────────────────────
